...
PLUGINLIB_EXPORT_CLASS(path_planner_rviz_wp_plugin::WaypointsToolSimUgv3, rviz::Tool)

namespace path_planner_rviz_wp_plugin
{

WaypointsToolSimUgv3::WaypointsToolSimUgv3(
...
//    }
    ...
    resource_success_ = "package://path_planner_rviz_wp_plugin/mesh/barrier_success3.dae";
