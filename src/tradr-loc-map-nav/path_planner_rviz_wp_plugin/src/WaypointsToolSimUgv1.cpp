...
PLUGINLIB_EXPORT_CLASS(path_planner_rviz_wp_plugin::WaypointsToolSimUgv1, rviz::Tool)

namespace path_planner_rviz_wp_plugin
{

WaypointsToolSimUgv1::WaypointsToolSimUgv1(
...
//    resource_success_ = "package://path_planner_rviz_wp_plugin/mesh/barrier_success1.dae";
