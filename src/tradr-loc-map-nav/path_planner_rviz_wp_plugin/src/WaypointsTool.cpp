...
)
{
    ...
    // failures cleanup
    failures_cleanup_ = node_.createTimer(ros::Duration(5), &WaypointsTool::failureCleanup, this);
...
//    markers_interactive_menu_.insert("Patrolling - Append task", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
//    markers_interactive_menu_.insert("Patrolling - Send task", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
//    markers_interactive_menu_.insert("Patrolling - Remove task", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
//    markers_interactive_menu_.insert("Patrolling - Pause", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
//    markers_interactive_menu_.insert("Patrolling - Restart", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
    ...
    //markers_interactive_menu_.insert("Exploration - set BB", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
...
void WaypointsTool::markerFailure(const std::string name)
{
    ...
    failures_cleanup_.stop();
    failures_cleanup_.start();
}
