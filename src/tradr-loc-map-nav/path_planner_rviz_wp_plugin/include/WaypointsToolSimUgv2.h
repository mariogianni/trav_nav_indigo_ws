...
#ifndef WAYPOINTS_TOOL_SIM_UGV2_H
#define WAYPOINTS_TOOL_SIM_UGV2_H
...
#define NAME_UGV "/ugv2"
#define NAME_PARAMETER_ROBOT_NAME "robot2_name"
...
class WaypointsToolSimUgv2: public WaypointsTool
{
    Q_OBJECT
public:
    WaypointsToolSimUgv2(  
